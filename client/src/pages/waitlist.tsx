  ...
  return <Shell>
    ...
    <main className="grid min-h-[calc(100dvh-110px)] items-center gap-14 px-6 py-12 lg:grid-cols-[1fr_0.82fr] lg:gap-24 lg:py-24">
      <section className="max-w-2xl">
        ...
        <h1 className="mt-6 max-w-xl font-serif text-[clamp(2rem,10vw,2.875rem)] leading-[.88] tracking-[-0.06em] sm:text-[clamp(3.25rem,5.4vw,4.25rem)] 2xl:max-w-[700px]">Meet someone worth leaving the app for.</h1>
        <p className="mt-8 max-w-md text-lg leading-8 text-[#77685f]">A more intentional dating experience for people ready to talk, connect <span className="whitespace-nowrap">and meet.</span></p>
