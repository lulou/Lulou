...
**How to apply:** Never infer voice-note access from message counts, call-stage availability, or `callStage > 0`. Render and enforce it from the persisted voice-note entitlement; keep the server’s valid-call completion result authoritative.